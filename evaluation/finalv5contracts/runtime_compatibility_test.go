...
func TestBenchmarkS2S4S5QueriesAndCanonicalNormalizerRemainFrozen(t *testing.T) {
	...
	// release may regenerate this byte string. v1.5 corrected the rationale in
	// the frozen baseline metadata only and deliberately left these bytes
	// alone: regenerating them re-pins normalization_spec_sha256 in all 135
	// oracle manifests, which is a live regeneration, not a text edit.
