# V4 kernel engineering evidence

`results.json` records the opt-in million-Fact offline publication and
fresh-process warm-HOT derivation checks. The tests enforce exact cardinality
before emitting a report and were run in 4 GiB builder and 512 MiB Gateway
