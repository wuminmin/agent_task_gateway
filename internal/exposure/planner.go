...
const ExactPlannerVersion = "taskgate-overlap-exact-v3"
...
// absent from the public planner response. The gateway constructs FactSets and
// utility evidence from executed plans; callers cannot submit either scalar.
