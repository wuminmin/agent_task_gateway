...
Parquet/object hashes and sizes, row/column counts, schema, result-metadata and
ACL hashes, hashed staging/canonical object keys, expiry, and the immediately following
